    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="icon"
          className="h-8 w-8 rounded-md hover:bg-blue-500/10 hover:text-blue-300"
        ...
        >
          ...
          >
            <DialogHeader className="gap-2">
              ...
              <DialogDescription>
                This will hide the conversation from the main list. You can restore it later.
              </DialogDescription>
            </DialogHeader>
            <span className="rounded-full border border-blue-500/25 bg-blue-500/10 px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.16em] text-blue-200">
              Archive
            </span>
          </div>
          <div style={{ padding: '28px 32px' }}>
            <p className="text-sm leading-7 text-[var(--text)]">
              Archived conversations are hidden from the sidebar but can be restored at any time.
            </p>
          </div>
          <div
            className="border-t border-white/5 bg-black/10"
          ...
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button type="submit" className="min-w-24 bg-blue-500 hover:bg-blue-400">
                  Archive
                </Button>
              </div>
            </div>
